const zh_tw = {
    ...
    volume_24H: '24h成交量',
    'Please use your computer to browse the web': '请使用电脑浏览网页',
    scatter_not_found: 'Scatter插件沒有找到',
    'LoginFaild': '登陸失敗',
    'Please unlock your TronPay wallet': '請解鎖你的TronPay錢包',
    scatter_tip: 'TronPay是一款Tron錢包，請您確定已經安裝TronPay.',
